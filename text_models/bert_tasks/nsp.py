...
class NextSentencePredictionTask(AbstractTask):
    def __init__(self, epochs=2, batch_size=16, n_examples="all", forget_const=10, save_steps=2000):
        super(NextSentencePredictionTask, self).__init__(epochs, batch_size, n_examples, name="nsp")
